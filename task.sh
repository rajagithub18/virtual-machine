...
az vm create --name vm1 -g activity1 --image UbuntuLTS --vnet-name net1 --subnet web --size Standard_B1s --public-ip-address vmpub --public-ip-sku Standard --public-ip-address-allocation dynamic --public-ip-sku Standard --nsg nsg1 --location eastus --admin-username devops --admin-password Motherindia@123 --authentication-type password
